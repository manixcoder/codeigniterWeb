      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Manager Form</h3>
          </div>
          ...
          <form  method="Post" role="form" action="" lpformnum="131" enctype = "multipart/form-data">
            <div class="box-body">               
              ...
              <div class="form-group">
                <label for="adminAadharImage">Aadhar Card Image</label>
                    <input class="form-control" id="adminAadharImage" name="adminAadharImage" type="file" />
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="adminPanImage">Pan Card Image</label>
                    <input class="form-control" id="adminPanImage" name="adminPanImage" type="file" />
              </div>
              <div class="form-group">
              ...
              <div class="form-group">                
                <input type="hidden" id="custId" name="adminUserType" value="admin">
              </div>
              ...
              <div class="form-group">
                <label for="managerResume">Manager Resume</label>
                <input class="form-control" id="managerResume" name="managerResume" accept=".pdf,.docx" type="file" /> 
              </div>
              <div class="form-group">
